...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '7960efb2-96f3-4ba1-a9d9-b82745611f02' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('9ba5f39a-3e5c-4c50-b723-afd8e470f2bb');
      cy.get(`[data-cy="name"]`).should('have.value', '9ba5f39a-3e5c-4c50-b723-afd8e470f2bb');
